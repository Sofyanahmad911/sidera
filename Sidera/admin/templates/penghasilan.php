...
<p class="paragraf-indent">Adalah benar warga Desa Serage. Berdasarkan data dan sepengetahuan kami, yang bersangkutan memiliki rata-rata penghasilan dengan rincian keterangan sebagai berikut:</p>

<div style="text-align: center; font-weight: bold; margin: 15px 0; text-transform: uppercase;">
    <?= htmlspecialchars($keperluan) ?>
</div>

<p style="text-align: justify;">Demikian Surat Keterangan Penghasilan ini kami buat dengan sebenar-benarnya untuk dapat dipergunakan sebagaimana mestinya. Apabila di kemudian hari keterangan ini terbukti tidak benar, maka kami bersedia dituntut sesuai dengan hukum yang berlaku.</p>