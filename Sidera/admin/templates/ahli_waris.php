...
<p class="paragraf-indent">Orang tersebut di atas adalah benar warga kami yang berdomisili di Desa Serage. Berdasarkan surat pernyataan dan keterangan yang bersangkutan, orang tersebut adalah Ahli Waris yang sah dari:</p>

<div style="text-align: center; font-weight: bold; margin: 15px 0; text-transform: uppercase;">
    <?= htmlspecialchars($keperluan) ?>
</div>

<p style="text-align: justify;">Demikian Surat Keterangan Ahli Waris ini dibuat dengan sebenar-benarnya untuk dapat dipergunakan sebagai kelengkapan administrasi. Segala akibat hukum yang timbul di kemudian hari sepenuhnya menjadi tanggung jawab ahli waris.</p>