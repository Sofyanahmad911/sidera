...
<div class="judul-surat">
    <div class="judul">SURAT PENGANTAR NIKAH</div>
...
<table class="tabel-identitas" style="margin-bottom: 20px;">
    ...
    <tr><td>Status Kawin</td><td>:</td><td><?= htmlspecialchars($warga['status_perkawinan']) ?></td></tr>
...
<p class="paragraf-indent">Memang benar orang tersebut di atas adalah warga Desa Serage dan bermaksud untuk melangsungkan pernikahan dengan rincian calon pasangan sebagai berikut:</p>
<div style="text-align: center; font-weight: bold; margin: 15px 0; text-transform: uppercase;">
    <?= htmlspecialchars($keperluan) ?>
</div>
<p class="paragraf-indent">Surat pengantar ini diberikan sebagai syarat untuk mengurus administrasi pernikahan (N1, N2, N3, N4) di Kantor Urusan Agama (KUA) Kecamatan Praya Barat Daya.</p>
<p style="text-align: justify;">Demikian surat pengantar nikah ini dibuat dengan sebenar-benarnya dan agar dapat dipergunakan sebagaimana mestinya.</p>